...
Also, We found that our system performed significant number random numbers with an average of 4600 random numbers per second with standard deviation of just 74 (\emph{i.e} 74 numbers away from average random number generation).
