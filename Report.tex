...
Karatsuba Multiplication\cite{karatsuba_multiplication} algorithm mentioned in section \ref{sec: karatsuba_code} was implemented to enhance the performance of multiplication also had significant performance. For key generation we worked to generate keys of size upto 512 bit keys and showed significant performance based on time of computation.
