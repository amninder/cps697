...
We measure the program and found the results for pairs of random \emph{n}-digit numbers. All times are in milliseconds. Table \ref{table:karatsubaVSgrade} and Figure \ref{table:karatsubaVSgrade} shows results we obtained.
...
\begin{figure}[ht!]
\centering
\includegraphics[width=90mm]{karatsuba_gradeSchool.jpg}
