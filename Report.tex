...
\subsection{\bf Using 3\textsuperscript{rd} prime number}%\cite{securersa}
\par \par
...
\section{Conclusion of using 2 pair of prime number VS introducing 3\textsuperscript{rd} prime number}
...
Comparing this results with the "\emph{File Encryption and Decryption using Secure RSA}"\cite{securersa}, we found that time taken for 32 bits-number reduced exponentially as we increase key space. on average our system performed 15 times more than old method.
