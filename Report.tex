...
\par \par
For STEP \ref{itm:step3} of algorithm of Section \ref{sec:secureMrea}, we found that there are only two possibilities:
...
Also, STEP \ref{itm:step6} of algorithm of Section \ref{sec:secureMrea} can be further enhanced by introducing third random prime number $x$. STEP \ref{itm:step6} of Section \ref{sec:secureMrea} can be written as: $e \times d \mod \phi = 1$, \emph{i.e}
\begin{equation}
e \times d = 1 + x(\phi)
\end{equation}
